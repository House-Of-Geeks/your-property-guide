...
async function main() {
  ...
  const dataSources = [
    ...
    { id: "crime-act",     label: "ACT Crime Statistics (data.act.gov.au)", category: "crime", schedule: "quarterly", sourceUrl: "https://www.data.act.gov.au/resource/2egm-dieb" },
    { id: "sales-abs",    label: "ABS SA2 Median Property Prices (ABS_REGIONAL_ASGS2021)", category: "sales",  schedule: "annual",    sourceUrl: "https://data.api.abs.gov.au/rest/data/ABS_REGIONAL_ASGS2021/" },
    { id: "housing-rai",  label: "Rental Affordability Index by Postcode (SGS Economics / housingdata.gov.au)", category: "rental", schedule: "annual", sourceUrl: "https://viz.aihw.gov.au/t/HDD/views/RentalAffordabilityIndex/RAI_2.csv" },
