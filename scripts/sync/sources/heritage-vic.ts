/**
 * VIC Heritage Overlay Ingest (Vicmap Planning — Planning Scheme Overlay Polygon)
 *
 * Filters the planning overlay layer by zone_code LIKE 'HO%' to capture
 * Heritage Overlay polygons (HO1, HO245, etc.) only.
 *
 ...
 *
 * Field mapping:
 *   zone_code        → overlay.code         (e.g. "HO1", "HO245")
