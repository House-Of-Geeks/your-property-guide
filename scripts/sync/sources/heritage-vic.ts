/**
 * VIC Heritage Overlay Ingest — Vicmap Planning (HO*).
 *
 ...
 *
 * Filter: `zone_code LIKE 'HO%'` (Heritage Overlay variations: HO1, HO2, …).
 */
...
const config: ArcGisPaginatedConfig = {
  ...
  sourceId: "heritage-vic",
  overlayKind: "heritage",
  overlaySource: "vic-vicmap-heritage",
  state: "VIC",
