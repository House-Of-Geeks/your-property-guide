/**
 * VIC Bushfire Management Overlay Ingest (Vicmap Planning — Planning Scheme Overlay Polygon)
 *
 * Filters the Vicmap Planning overlay layer by zone_code = 'BMO' (Bushfire Management
 * Overlay) to attach a parcel-level bushfire flag to VIC G-NAF addresses.
 *
 ...
 *
 * Field mapping:
 *   zone_code        → overlay.code         (e.g. "BMO")
