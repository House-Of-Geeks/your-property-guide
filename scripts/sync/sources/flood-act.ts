...
const SOURCE_ID = "flood-act";
const OVERLAY_KIND = "flood";
const OVERLAY_SOURCE = "act-flood-extent";
const STATE = "ACT";
const ARC_BASE = "https://services1.arcgis.com/E5n4f1VY84i0xSjy/arcgis/rest/services/ACTGOV_FLOOD_EXTENT/FeatureServer/0";
const CACHE_DIR = join(process.cwd(), ".cache", "flood-act");
        ...
        for (const a of batch) {
          ...
          if (m) {
            ...
            writeBuffer.push({
              addressId: a.id,
              code:      "1% AEP",
              label:     "Modelled flood extent (1% AEP)",
              attrs:     JSON.stringify({ modelled: true }),
              effectiveAt: null,
            });
