/**
 * ACT Strategic Bushfire Management Plan — Bushfire Prone Areas (BPA) Ingest
 *
...
const SOURCE_ID = "bushfire-act";
const OVERLAY_KIND = "bushfire";
const OVERLAY_SOURCE = "act-sbmp-bpa";
const STATE = "ACT";
const ARC_BASE = "https://services1.arcgis.com/E5n4f1VY84i0xSjy/arcgis/rest/services/SBMP_BPA_current/FeatureServer/0";
const CACHE_DIR = join(process.cwd(), ".cache", "bushfire-act");
        ...
        for (const a of batch) {
          ...
          if (m) {
            ...
            writeBuffer.push({
              addressId: a.id,
              code:      "BPA",
              label:     "Bushfire Prone Area (SBMP 2025)",
              attrs:     JSON.stringify({ source: "SBMP 2025" }),
              effectiveAt: null,
            });
