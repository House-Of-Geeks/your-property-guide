...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title = `Townhouses for Sale in ${suburb.name}, ${suburb.state}`;
  ...
  const listingCount = await countProperties({ listingType: "buy", suburb: slug, propertyType: "townhouse" });
  return {
    title,
    description,
    ...
    openGraph: {
      url: `${SITE_URL}/suburbs/${slug}/townhouses`,
