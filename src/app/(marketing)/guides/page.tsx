...
const SECTIONS: GuideSection[] = [
  {
    ...
    guides: [
      ...
      { title: "Stamp Duty NSW",                            href: "/guides/stamp-duty-nsw", readTime: "7 min", description: "NSW rates, worked examples, and the first home buyer exemption to $800K." },
      { title: "Stamp Duty VIC",                            href: "/guides/stamp-duty-vic", readTime: "7 min", description: "Victorian land transfer duty, worked examples, and the $600K first home exemption." },
      { title: "Stamp Duty QLD",                            href: "/guides/stamp-duty-qld", readTime: "7 min", description: "Queensland transfer duty, the 2024 first home concession to $700K, and worked examples." },
      { title: "Stamp Duty WA",                             href: "/guides/stamp-duty-wa",  readTime: "7 min", description: "WA transfer duty rates, the first home owner rate, and worked examples." },
      { title: "Stamp Duty SA",                             href: "/guides/stamp-duty-sa",  readTime: "7 min", description: "South Australian rates, worked examples, and the new-home first home exemption." },
      { title: "Stamp Duty TAS",                            href: "/guides/stamp-duty-tas", readTime: "7 min", description: "Tasmanian duty, the 50% first home concession, and worked examples." },
      { title: "Stamp Duty NT",                             href: "/guides/stamp-duty-nt",  readTime: "7 min", description: "Northern Territory conveyance duty, worked examples, and the $10K FHOG." },
      { title: "Stamp Duty ACT",                            href: "/guides/stamp-duty-act", readTime: "7 min", description: "ACT duty rates and the income-tested Home Buyer Concession Scheme." },
