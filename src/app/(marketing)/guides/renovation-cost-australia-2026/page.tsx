  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li><strong>Labour</strong> remains the binding constraint. Construction trades shortages haven&rsquo;t eased — apprenticeships dropped in the late 2010s and the pipeline is still thin. Expect 6–12 week waits to engage a quality builder for anything substantial.</li>
      ...
      <p>
        ...
        rules vary significantly — read our <Link href="/guides/granny-flat-guide-nsw">granny flat guides</Link> for the full
      ...
      <ul>
        ...
        <li><strong>Second storey / extension</strong>: 0.7× to 1.0× cost recovered in most suburbs; can exceed 1.0× in high-end suburbs where per-m² value is high.</li>
